...
public class 윤현기최하은_Control {
	...
	public void control() {
		...
		윤현기최하은_HomeControl light = new 윤현기최하은_Light();
		윤현기최하은_HomeControl tv = new 윤현기최하은_TV();
		윤현기최하은_HomeControl aircon = new 윤현기최하은_Aircon();
					...
					case 3:
						...
						switch(order3) {
							...
							case "꺼줘":
								...
								break;
							case "타이머":
								if (((윤현기최하은_Aircon) aircon).isPowerOn()) { //타이머 실행 전에 에어컨 상태 확인
									System.out.println("타이머를 설정해주세요");
									isTimerRunning = true;
									윤현기최하은_MyTimer myTimer = new 윤현기최하은_MyTimer();
									myTimer.start();
