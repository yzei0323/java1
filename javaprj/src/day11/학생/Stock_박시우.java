...
public class Stock_박시우 {
	...
	public Stock_박시우(String stock, int cnt) {
		this.stock=stock;
		this.cnt=cnt;
	}
	
	public Stock_박시우(String stock, int cnt, int bid, double volatility, double limit_order_over, double limit_order_under, int currentPrice) {
		this.stock=stock;
		this.cnt=cnt;
		this.bid=bid;
