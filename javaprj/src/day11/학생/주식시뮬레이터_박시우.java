...
public class 주식시뮬레이터_박시우 {
	ArrayList<Stock_박시우> list = new ArrayList<>();
	Scanner sc = new Scanner(System.in);

	public static void main(String[] args) {
		주식시뮬레이터_박시우 stock_simul = new 주식시뮬레이터_박시우();
		stock_simul.run();
	}
	...
	public void createStocks() {
		loop: while (true) {
			...
			if (buyOrsell.equals("구매")) {
				...
				list.add(new Stock_박시우(sc.next(), sc.nextInt()));
			} else {
				break loop;
			}
		}
