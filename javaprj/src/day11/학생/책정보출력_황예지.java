...
public class 책정보출력_황예지 {
	
	Scanner sc = new Scanner(System.in);
	
	Book_황예지[] books = new Book_황예지[5];	//5개 이내 등록가능
	...
	public void 등록하기() {
		...
		Book_황예지 b = new Book_황예지(title, author, price);
		books[index] = b;
		index++;
	}
	...
	public void 변경하기() {
		...
		case 1: 
			...
			Book_황예지 update1 = books[updateNo];
		...
		case 2:
			...
			Book_황예지 update2 = books[updateNo];
		...
		case 3:
			...
			Book_황예지 update3 = books[updateNo];
