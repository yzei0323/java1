...
public class 황예지_책정보출력 {
	
	Scanner sc = new Scanner(System.in);
	
	황예지_Book[] books = new 황예지_Book[5];	//5개 이내 등록가능
	...
	public void 등록하기() {
		...
		황예지_Book b = new 황예지_Book(title, author, price);
		books[index] = b;
		index++;
	}
	...
	public void 변경하기() {
		...
		case 1: 
			...
			황예지_Book update1 = books[updateNo];
		...
		case 2:
			...
			황예지_Book update2 = books[updateNo];
		...
		case 3:
			...
			황예지_Book update3 = books[updateNo];
