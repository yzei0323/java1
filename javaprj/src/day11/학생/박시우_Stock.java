...
public class 박시우_Stock {
	...
	public 박시우_Stock(String stock, int cnt) {
		this.stock=stock;
		this.cnt=cnt;
	}
	
	public 박시우_Stock(String stock, int cnt, int bid, double volatility, double limit_order_over, double limit_order_under, int currentPrice) {
		this.stock=stock;
		this.cnt=cnt;
		this.bid=bid;
