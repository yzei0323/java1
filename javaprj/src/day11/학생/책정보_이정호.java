...
public class 책정보_이정호 {

	public static void main(String[] args) {
		Scanner scan = new Scanner(System.in);
		
		Book_이정호[] list = new Book_이정호[4];

		list[0] = new Book_이정호("국어책", "국어교수", 12000);
		list[1] = new Book_이정호("수학책", "수학교수", 14000);
		list[2] = new Book_이정호("영어책", "영어교수", 16000);
		list[3] = new Book_이정호("과학책", "과학교수", 18000);
