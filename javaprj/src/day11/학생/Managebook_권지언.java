...
public class Managebook_권지언 {

	static int idx = 0;
	static Book_권지언[] arr = new Book_권지언[0];
	...
	public static Book_권지언[] createBook(Book_권지언[] arr, String title, String author, int price) {
		Book_권지언 newBook = new Book_권지언(title, author, price);
		Book_권지언[] newBooks = new Book_권지언[arr.length + 1];
	...
	public static Book_권지언[] deleteBook(Book_권지언[] arr, int deleteIndex) {
	...
	public static void updateBook(Book_권지언[] arr, int updateIndex, Scanner sc) {
		if (updateIndex < 0 || updateIndex >= arr.length) {
			...
			if (input.equals("제목")) {
				...
				Book_권지언 search = arr[updateIndex];
