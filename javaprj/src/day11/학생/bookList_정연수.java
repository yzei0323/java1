...
public class bookList_정연수 {

	book_정연수 b = new book_정연수("반지의제왕", "J.R.R 톨킨", 100000);
	book_정연수 b2 = new book_정연수("메트로2033", "드미트리 글루홉스키", 40000);
	book_정연수 b3 = new book_정연수("헝거게임", "수잔 콜린스", 41000);
	Scanner sc = new Scanner(System.in);
	int index = 0;
	book_정연수[] bookList = new book_정연수[3];
	book_정연수[] boList = new book_정연수[3];
	
	public void makeList() {
		bookList[0] = new book_정연수("반지의제왕", "J.R.R 톨킨", 100000);
		bookList[1] = new book_정연수("메트로2033", "드미트리 글루홉스키", 40000);
		bookList[2] = new book_정연수("헝거게임", "수잔 콜린스", 41000);
	}
