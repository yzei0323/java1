...
public class 정연수_bookList {

	정연수_book b = new 정연수_book("반지의제왕", "J.R.R 톨킨", 100000);
	정연수_book b2 = new 정연수_book("메트로2033", "드미트리 글루홉스키", 40000);
	정연수_book b3 = new 정연수_book("헝거게임", "수잔 콜린스", 41000);
	Scanner sc = new Scanner(System.in);
	int index = 0;
	정연수_book[] bookList = new 정연수_book[3];
	정연수_book[] boList = new 정연수_book[3];
	
	public void makeList() {
		bookList[0] = new 정연수_book("반지의제왕", "J.R.R 톨킨", 100000);
		bookList[1] = new 정연수_book("메트로2033", "드미트리 글루홉스키", 40000);
		bookList[2] = new 정연수_book("헝거게임", "수잔 콜린스", 41000);
	}
